        ...
        for date_str in dates:
            ...
            for item in full_json_data:
                try:
                    ...
                    opposite_advocate = sanitize_text(item.get('mradv'))
                    ...
                    case_data = {
                        ...
                        "respondent": respondent,
                        "advocate": advocate,
                        "opposite_advocate": opposite_advocate,
                        "hearing_date": hearing_date,
                        "case_type": case_type,
                        "raw_text": raw_text,
                    ...
                    if extras and isinstance(extras, list):
                        for extra in extras:
                            ...
                            ex_opposite_advocate = sanitize_text(extra.get('exradv'))
                            ...
                            ex_case_data = {
                                ...
                                "opposite_advocate": ex_opposite_advocate,
                                "hearing_date": hearing_date,
