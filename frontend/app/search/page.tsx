...
export default function SearchPage() {
  ...
  const handleSearch = async () => {
    ...
    if (oppositeAdvocate) params.append('opposite_advocate', oppositeAdvocate)
      ...
      <main style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
            ...
            <div>
              <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '500' }}>Opposite Advocate</label>
              <input
                type="text"
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: '1000px' }}>
              <thead>
                <tr style={{ background: '#f5f5f5', borderBottom: '2px solid #ddd' }}>
                  ...
                  <th style={{ padding: '1rem', textAlign: 'left' }}>Opp. Advocate</th>
              ...
              <tbody>
                {results.map((cause) => (
                  ...
                  >
                    ...
                    <td style={{ padding: '1rem' }}>{cause.opposite_advocate || 'N/A'}</td>
